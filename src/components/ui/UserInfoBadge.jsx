  ...
  return (
    ...
    >
      <button
        ...
        className="
          w-[9.2rem] sm:w-[11rem] md:w-[12.6rem]
          rounded-[1.2rem] px-2.5 sm:px-3.5 py-2 sm:py-2.5
          bg-[radial-gradient(circle_at_top_left,_rgba(88,148,255,0.18),_rgba(16,36,101,0.94)_36%,_rgba(8,18,58,0.98)_100%)]
          backdrop-blur-md
          shadow-[0_12px_26px_rgba(5,16,54,0.42),0_0_18px_rgba(44,108,255,0.16),inset_0_1px_0_rgba(194,225,255,0.16)]
          hover:scale-[1.01]
      ...
      >
        <span
          ...
          className="
            ...
            text-[1.5rem] shadow-[0_6px_16px_rgba(37,99,235,0.35)]
            sm:h-12 sm:w-12 sm:text-[1.8rem]
          "
        >
          {'\u{1F60E}'}
        </span>

        <span className="flex min-w-0 flex-1 flex-col items-start text-left leading-snug text-white drop-shadow-sm">
          <span
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-[248px]">
          <div className="rounded-[1.2rem] bg-[radial-gradient(circle_at_top_left,_rgba(88,148,255,0.18),_rgba(16,36,101,0.94)_36%,_rgba(8,18,58,0.98)_100%)] shadow-[0_12px_26px_rgba(5,16,54,0.42),0_0_18px_rgba(44,108,255,0.16),inset_0_1px_0_rgba(194,225,255,0.16)]">
            <div className="relative overflow-hidden rounded-[1.2rem] text-white backdrop-blur-md">
              <div className="pointer-events-none absolute -top-14 -right-12 h-28 w-28 rounded-full bg-sky-400/12 blur-2xl" />
              <div className="pointer-events-none absolute -bottom-16 -left-12 h-32 w-32 rounded-full bg-cyan-400/10 blur-2xl" />
              <span className="pointer-events-none absolute top-2.5 left-3 text-[12px] font-black text-sky-100/35">+</span>
              <span className="pointer-events-none absolute top-2.5 right-3 text-[12px] font-black text-cyan-100/35">-</span>

              <div className="relative space-y-2 p-3 text-sm">
                <div className="flex items-center justify-between gap-3">
                  <span className="text-sky-100/72">Total Score</span>
                  <span className="font-extrabold tabular-nums">{totalScore}</span>
                </div>
                <div className="flex items-center justify-between gap-3">
                  <span className="text-sky-100/72">Total Time</span>
                ...
                {isLoadingStats && (
                  <div className="pt-1 text-xs text-sky-100/70">Updating...</div>
                )}
              </div>
            </div>
          </div>
