...
const GameModeLightningCompleteScreen = () => {
  ...
  return (
    <>
      <style>{`
        .lightning-complete-card {
          animation: lightning-complete-card-in 760ms cubic-bezier(0.22, 1, 0.36, 1) both;
        }

        .lightning-complete-title {
          animation: lightning-complete-title-glow 2.8s ease-in-out infinite;
        }

        .lightning-complete-top-badge {
          animation: lightning-complete-badge-float 2.6s ease-in-out infinite;
        }

        .lightning-complete-button {
          animation: lightning-complete-button-pulse 2.4s ease-in-out infinite;
        }

        .lightning-complete-sparkle {
          position: absolute;
          border-radius: 9999px;
          pointer-events: none;
          opacity: 0.72;
          animation: lightning-complete-float 7s ease-in-out infinite;
        }

        .lightning-complete-sparkle::after {
          content: '';
          position: absolute;
          inset: 0;
        ...
        .lightning-complete-banner-wrap {
          position: relative;
          width: 100%;
        ...
        .lightning-complete-banner-wrap::before,
        .lightning-complete-banner-wrap::after {
          content: '';
          position: absolute;
          top: 50%;
          display: none;
        ...
        @keyframes lightning-complete-card-in {
          0% { opacity: 0; transform: translateY(24px) scale(0.94); }
          100% { opacity: 1; transform: translateY(0) scale(1); }
        }

        @keyframes lightning-complete-title-glow {
        ...
        @keyframes lightning-complete-badge-float {
        ...
        @keyframes lightning-complete-button-pulse {
        ...
        @keyframes lightning-complete-float {
      ...
      >
        ...
        <span className="lightning-complete-sparkle left-[8%] top-[14%] h-2.5 w-2.5" style={{ animationDelay: '0s' }} />
        <span className="lightning-complete-sparkle left-[18%] top-[68%] h-3 w-3" style={{ animationDelay: '1.1s' }} />
        <span className="lightning-complete-sparkle left-[74%] top-[22%] h-2 w-2" style={{ animationDelay: '0.7s' }} />
        <span className="lightning-complete-sparkle left-[84%] top-[58%] h-3.5 w-3.5" style={{ animationDelay: '1.8s' }} />
        <span className="lightning-complete-sparkle left-[58%] top-[12%] h-2.5 w-2.5" style={{ animationDelay: '1.3s' }} />
        <span className="lightning-complete-sparkle left-[38%] top-[78%] h-2 w-2" style={{ animationDelay: '0.4s' }} />

        <div className="relative flex min-h-full items-center justify-center py-8">
          <div className="w-full max-w-4xl">
            <div className="lightning-complete-card rounded-[38px] bg-[linear-gradient(145deg,rgba(120,233,255,0.3),rgba(87,116,255,0.22),rgba(18,25,78,0.72))] p-[1.5px] shadow-[0_26px_70px_rgba(3,10,26,0.7),0_0_34px_rgba(96,165,250,0.18)]">
              <div className="relative overflow-hidden rounded-[36px] bg-[linear-gradient(180deg,rgba(14,27,86,0.88),rgba(10,20,66,0.95))] px-6 py-8 text-center backdrop-blur-xl sm:px-10 sm:py-10 lg:px-12 lg:py-12">
                ...
                <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center">
                  <div className="pointer-events-none absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2">
                    <div className="lightning-complete-top-badge flex h-[3.8rem] w-[3.8rem] items-center justify-center rounded-full bg-gradient-to-b from-[#9af4ff] via-[#4cd8ff] to-[#1788d8] text-[1.8rem] shadow-[0_0_24px_rgba(103,232,249,0.45),0_14px_28px_rgba(14,165,233,0.26)] sm:h-[4.7rem] sm:w-[4.7rem] sm:text-[2.2rem]">
                      ⚡
                    </div>
                  </div>

                  <div className="lightning-complete-banner-wrap mb-7 mt-6 sm:mt-8">
                    <div className="lightning-complete-banner px-6 py-3 text-center sm:px-10 sm:py-3.5">
                      <div
                  ...
                  <h1 className="lightning-complete-title flex w-full max-w-[40rem] flex-col items-center gap-3 text-center font-black uppercase sm:gap-4">
            ...
            <button
              type="button"
              onClick={goNext}
              className="lightning-complete-button mx-auto mt-8 block rounded-[22px] bg-[linear-gradient(145deg,rgba(74,222,128,0.96),rgba(22,163,74,0.96),rgba(20,83,45,0.98))] px-8 py-3.5 text-lg font-black tracking-[0.08em] text-white shadow-[0_18px_40px_rgba(34,197,94,0.26)] transition hover:brightness-110 sm:px-10 sm:py-4 sm:text-xl"
            >
              Next
            </button>
          </div>
