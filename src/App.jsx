...
const GameModeBonusVideoIntroScreen = lazy(() => import('./components/GameModeBonusVideoIntroScreen.jsx'));
const GameModeBonusIntroScreen = lazy(() => import('./components/GameModeBonusIntroScreen.jsx'));
...
const App = () => {
  ...
  const showScreenStatsDock = useMemo(() => {
    const routesWithStats = new Set([
      ...
      '/game-mode-rocket-complete',
      '/game-mode-bonus-intro',
      '/learning',
      '/pretest-intro',
      '/pretest-result',
    ]);
  ...
  return (
    <MathGameContext.Provider value={providerValue}>
      ...
      <Routes>
        ...
        <Route path="/game-mode-bonus-video-intro" element={<GameModeBonusVideoIntroScreen />} />
        <Route path="/game-mode-bonus-intro" element={<GameModeBonusIntroScreen />} />
              ...
              <div className="relative overflow-hidden rounded-[26px] border border-[#bfe2ff]/15 bg-[radial-gradient(circle_at_top_left,_rgba(88,148,255,0.18),_rgba(16,36,101,0.94)_36%,_rgba(8,18,58,0.98)_100%)] backdrop-blur-md">
                ...
                <div className="relative p-5 sm:p-6">
                  ...
                  <div className="flex w-full gap-3 sm:gap-4">
                    <button
                      className="h-14 flex-1 rounded-xl border border-[#bfe2ff]/20 bg-[linear-gradient(135deg,#2d74ff_0%,#1747c8_55%,#0f2a75_100%)] text-base font-black tracking-wide text-white shadow-[0_12px_24px_rgba(7,20,71,0.34),0_0_14px_rgba(44,108,255,0.22)] transition-all duration-200 hover:-translate-y-0.5 hover:brightness-110 active:translate-y-0 sm:text-lg"
                      onClick={ctx.handleConfirmQuit}
                    >
                      YES
                    </button>
                    <button
                      className="h-14 flex-1 rounded-xl border border-[#bfe2ff]/16 bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(214,235,255,0.92))] text-base font-black tracking-wide text-[#243c66] shadow-[0_12px_24px_rgba(7,20,71,0.2)] transition-all duration-200 hover:-translate-y-0.5 hover:brightness-105 active:translate-y-0 sm:text-lg"
